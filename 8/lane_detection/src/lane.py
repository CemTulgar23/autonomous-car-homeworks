...
class Lane:
  ...
  def calculate_car_position(self, print_to_terminal=False):
    ...
    # self.XM_PER_PIX * 100 -> piksel cinsinden olan değeri santimetreye çevirmek için kullanılıyor
  ...
  def get_lane_line_indices_sliding_windows(self, plot=False):
    ...
    for window in range(no_of_windows):
      ...
      # Identify window boundaries(pencere sınırları) in x and y (and right and left)
  ...
  def get_line_markings(self, frame=None):
    ...
    # şerit belirleme için hls renk uzayı bgr renk uzayından daha iyi
  ...
  def plot_roi(self, frame=None, plot=False):
    ...
    # ilgi alanını belirlemek için görüntü üzerinde bir dörtgen oluşturduk
